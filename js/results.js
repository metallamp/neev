...
function renderResults(data) {
  ...
  document.getElementById('macroLegend').innerHTML = `
    ...
    <div class="macro-legend-item"><div class="dot" style="background:var(--primary)"></div>Fat ${macros.fat.percent}%</div>
  `;
  ...
  document.getElementById('macroCards').innerHTML = `
    ...
    <div class="card" style="text-align:center;padding:20px;">
      <div style="font-size:2rem;font-weight:800;color:var(--primary);font-family:var(--font-heading);">${macros.fat.grams}g</div>
